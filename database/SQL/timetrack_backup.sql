...
CREATE TABLE `auditorias` (
  ...
  `fichaje_id` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `auditorias_ibfk_2` FOREIGN KEY (`fichaje_id`) REFERENCES `fichajes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `credenciales` (
  ...
  PRIMARY KEY (`usuario_id`),
  CONSTRAINT `credenciales_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleados` (
  `id` int(11) NOT NULL,
  `historialFichaje` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`historialFichaje`)),
  PRIMARY KEY (`id`),
  CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fichajes` (
  ...
  CONSTRAINT `fichajes_ibfk_2` FOREIGN KEY (`qr_id`) REFERENCES `qrs` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fichajes_ibfk_3` FOREIGN KEY (`foto_id`) REFERENCES `fotos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fotos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ruta_imagen` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `timestamp` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES ('os7M6C4D9iNe6lu39gij60VgpTfSNZmm3zC5BKzQ',NULL,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36','YTozOntzOjY6Il90b2tlbiI7czo0MDoiTGl1MnlEbXdyRWxzblpROEduUmN4TXBZVlVOWVBGeVdGUUJFNlBCYiI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MTY6Imh0dHA6Ly9sb2NhbGhvc3QiO31zOjY6Il9mbGFzaCI7YToyOntzOjM6Im9sZCI7YTowOnt9czozOiJuZXciO2E6MDp7fX19',1746611862);
...
CREATE TABLE `usuarios` (
  ...
  `role` enum('empleado','administrador') COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `usuarios` VALUES (3,'Oscar','000000000','oscardelgadohuertas@hotmail.com','$2y$12$qPVCZMxWsU8mLZ1GmBn4wuxZ9HXouGiEDlWIeCu5fhAbUm/OUWR5C','empleado',0,NULL,'2025-05-04 18:50:15','2025-05-04 18:50:15');
...
-- Dump completed on 2025-05-07 13:29:18
