...
class TestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('usuarios')->insert([
            ['id' => 1, 'name' => 'Empleado Prueba 1', 'dni' => '000000001', 'email' => 'empleado1@test.com', 'password' => bcrypt('empleado1'), 'role' => 'empleado', 'consiente_datos' => 0],
            ['id' => 2, 'name' => 'Empleado Prueba 2', 'dni' => '000000002', 'email' => 'empleado2@test.com', 'password' => bcrypt('empleado2'), 'role' => 'empleado', 'consiente_datos' => 0],
            ['id' => 3, 'name' => 'Empleado Prueba 3', 'dni' => '000000003', 'email' => 'empleado3@test.com', 'password' => bcrypt('empleado3'), 'role' => 'empleado', 'consiente_datos' => 0],
