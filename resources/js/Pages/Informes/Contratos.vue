                ...
                <div class="w-full overflow-x-auto shadow rounded-lg">
                    <table class="min-w-[300px] w-full bg-white shadow rounded-lg text-sm">
                        ...
                        <tr>
                            ...
                            <th class="p-1 text-left">Horas Semanales</th>
                            <th class="p-1 text-left">Inicio del Contrato</th>
                            <th class="p-1 text-left">Fin del Contrato</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="contrato in contratosFiltrados" :key="contrato.id"
                            ...
                            <td class="p-1">{{ contrato.horas }}</td>
                            <td class="p-1">
